...
| Tool | Preview |
|------|---------|
| Google Looker Studio |  <img src=Data Engineering Capstone Project/Labs/Dashboard Creation using Google Looker Studio/Screenshots/E-Commerce_Sales_Dashboard_(2020).pdf"|
